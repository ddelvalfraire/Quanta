...
object Main {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val iterations = sys.env.getOrElse("BENCH_ITERATIONS", "50").toInt

    System.err.println(s"Akka benchmark: warmup=$warmup, iterations=$iterations")
